    ...
    'clb-custom-blocks/collapse',
    {
        ...
        save: props => {
                    ...
                    return (
                         ...
                         <div class="collapse-button-area" style={ {backgroundColor: backgroundColor} }>{title}<span class="dashicons down dashicons-arrow-down-alt2"></span><span class="dashicons up dashicons-arrow-up-alt2"></span></div></a>
